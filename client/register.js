...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var loginButton = document.getElementById('loginNavigationButton');
    ...
    registrationForm.addEventListener('submit', function (event) { return __awaiter(_this, void 0, void 0, function () {
        var username, password, response, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, fetch('http://localhost:4200/register', {
                            method: 'POST', // Verwendet POST-Methode.
                            headers: {
                                'Content-Type': 'application/json', // Setzt den Content-Type des Requests auf 'application/json'.
                            },
                            body: JSON.stringify({ username: username, password: password, }), // Sendet die Benutzerdaten im JSON-Format.
                        })];
                case 2:
                    response = _a.sent();
                ...
                case 3:
                    ...
                    console.error('Netzwerkfehler:', error_1);
                    return [3 /*break*/, 4];
